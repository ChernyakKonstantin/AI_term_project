...
class ExperienceBuffer:
    ...
    def __init__(self, is_new, capacity, seq_len, height, width, channels):
        """
        Parameters
        ----------
        is_new : bool
        ...
        self.states = np.memmap("states.npy", dtype=np.float32, mode=mode,
                                shape=(capacity, seq_len, height, width, channels))
    ...
    def append(self, state, next_state, action, reward, is_done):
        ...
        ----------
        state : numpy array
            numpy array of the following shape [seq_len, height, width, channels].
        ...
        """
        # state is list of [np.array shape of [seq_len, height, width, channels], np.array shape of [seq_len, height, width, channles]]
