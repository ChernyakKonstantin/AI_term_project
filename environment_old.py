...
class Environment:
    ...
    def __init__(self, app_title, seq_len, viewport_size):
        ...
        # time.sleep(1)
        self.read_path = r'C:\Users\zvfrf\Desktop\Учеба\AI_term_project\environment_app\status.dat'
        self.write_path = r'C:\Users\zvfrf\Desktop\Учеба\AI_term_project\environment_app\actions.dat'
    ...
    def _get_observation(self):
        ...
        for seq_index in range(self.seq_len):
            ...
            # norm_image = cv2.resize(norm_image, (80, 80))  # Hard-Coded 64x64 #was 64x64
