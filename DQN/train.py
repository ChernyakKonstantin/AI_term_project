...
#Load the collision screen message
INTERRUPTION_MESSAGE = np.asarray(ImageOps.grayscale(Image.open(IMAGE_PATH)))

env = Environment(APP_TITLE, RESET_BTN, INTERRUPTION_MESSAGE, MESSAGE_REGION, SEQ_LEN, VIEWPORT_SIZE)
